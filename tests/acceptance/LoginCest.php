...
class LoginCest {
    ...
    public function testRequiredFields(AcceptanceTester $I) {
        ...
        // Test validation
        $I->click('Submit');
        $I->expect('Login is required');
        $I->expect('Password is required');
    }
    ...
    public function testPasswordWrong(AcceptanceTester $I) {
        ...
        $I->click('Submit');
        $I->expect('Login or Password not founded');
    }
    ...
    public function testSizeOfFields(AcceptanceTester $I) {
        ...
        $I->click('Submit');
        $I->expect('Login max size is 100 characters');
        $I->expect('Password max size is 100 characters');
    }
